	...
	: QDialog(Parent), ui(new Ui::lcAboutDialog)
{
	...
	ui->version->setText(tr("SECAD Continuous Build %1").arg(QString::fromLatin1(QT_STRINGIFY(LC_CONTINUOUS_BUILD))));
#else
	ui->version->setText(tr("SECAD Version %1").arg(QString::fromLatin1(LC_VERSION_TEXT)));
#endif

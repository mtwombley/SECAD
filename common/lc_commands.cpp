...
const lcCommand gCommands[] =
{
	...
	// LC_HELP_HOMEPAGE
	{
		...
		QT_TRANSLATE_NOOP("Menu", "SECAD &Home Page"),
		QT_TRANSLATE_NOOP("Status", "Open SECAD's home page on the internet using your default web browser"),
		""
	},
	// LC_HELP_BUG_REPORT
	{
		...
		QT_TRANSLATE_NOOP("Status", "Open SECAD's bug report form on your default web browser"),
		""
	},
	// LC_HELP_UPDATES
	{
		...
		QT_TRANSLATE_NOOP("Status", "Check if a newer SECAD version or parts library has been released"),
		""
	},
	// LC_HELP_ABOUT
	{

...
inline lcVector3 lcVector3LDrawToSECAD(const lcVector3& Vector)
{
...
inline lcMatrix44 lcMatrix44SECADToLDraw(const lcMatrix44& Matrix)
{
	lcMatrix44 m;
...
inline lcMatrix44 lcMatrix44LDrawToSECAD(const lcMatrix44& Matrix)
{
	lcMatrix44 m;

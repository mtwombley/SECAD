...
#define LC_CAMERA_SAVE_VERSION 7 // SECAD 0.80
...
void lcCamera::SaveLDraw(QTextStream& Stream) const
{
	...
	Stream << QLatin1String("0 !SECAD CAMERA FOV ") << m_fovy << QLatin1String(" ZNEAR ") << m_zNear << QLatin1String(" ZFAR ") << m_zFar << LineEnding;
	...
	Stream << QLatin1String("0 !SECAD CAMERA ");

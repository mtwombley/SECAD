...
void lcViewWidget::dragEnterEvent(QDragEnterEvent* DragEnterEvent)
{
	...
	if (MimeData->hasFormat("application/vnd.SECAD-part"))
	{
		DragEnterEvent->acceptProposedAction();
		mView->BeginDrag(lcDragState::Piece);
		return;
	}
	else if (MimeData->hasFormat("application/vnd.SECAD-color"))
	{
		DragEnterEvent->acceptProposedAction();
...
void lcViewWidget::dragMoveEvent(QDragMoveEvent* DragMoveEvent)
{
	...
	if (MimeData->hasFormat("application/vnd.SECAD-part") || MimeData->hasFormat("application/vnd.SECAD-color"))
	{
		float DeviceScale = GetDeviceScale();

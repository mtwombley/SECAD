...
void lcQPreferencesDialog::accept()
{
	...
	{
		QMessageBox::information(this, "SECAD", tr("Grid spacing must be greater than 0."));
		return;
	}
...
void lcQPreferencesDialog::on_deleteCategory_clicked()
{
	...
	if (QMessageBox::question(this, "SECAD", question, QMessageBox::Yes | QMessageBox::No) != QMessageBox::Yes)
		return;
...
void lcQPreferencesDialog::on_importCategories_clicked()
{
	...
	{
		QMessageBox::warning(this, "SECAD", tr("Error loading categories file."));
		return;
	}
...
void lcQPreferencesDialog::on_exportCategories_clicked()
{
	...
	{
		QMessageBox::warning(this, "SECAD", tr("Error saving categories file."));
		return;
	}
}
...
{
	if (QMessageBox::question(this, "SECAD", tr("Are you sure you want to load the default categories?"), QMessageBox::Yes | QMessageBox::No) != QMessageBox::Yes)
		return;
...
void lcQPreferencesDialog::on_shortcutsImport_clicked()
{
	...
	{
		QMessageBox::warning(this, "SECAD", tr("Error loading keyboard shortcuts file."));
		return;
	}
...
void lcQPreferencesDialog::on_shortcutsExport_clicked()
{
	...
	{
		QMessageBox::warning(this, "SECAD", tr("Error saving keyboard shortcuts file."));
		return;
	}
}
...
{
	if (QMessageBox::question(this, "SECAD", tr("Are you sure you want to load the default keyboard shortcuts?"), QMessageBox::Yes | QMessageBox::No) != QMessageBox::Yes)
		return;
...
void lcQPreferencesDialog::on_MouseImportButton_clicked()
{
	...
	if (!Shortcuts.Load(FileName))
	{
		QMessageBox::warning(this, "SECAD", tr("Error loading mouse shortcuts file."));
		return;
	}
...
void lcQPreferencesDialog::on_MouseExportButton_clicked()
{
	...
	if (!mOptions->MouseShortcuts.Save(FileName))
		QMessageBox::warning(this, "SECAD", tr("Error saving mouse shortcuts file."));
}

void lcQPreferencesDialog::on_mouseReset_clicked()
{
	if (QMessageBox::question(this, "SECAD", tr("Are you sure you want to load the default mouse shortcuts?"), QMessageBox::Yes | QMessageBox::No) != QMessageBox::Yes)
		return;

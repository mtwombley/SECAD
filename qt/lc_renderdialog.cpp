...
{
	QString LogFile = mCommand == POVRAY_RENDER ? QLatin1String("SECAD-povray-render.out") : QLatin1String("SECAD-blender-render.out");
...
{
	QString LogFile = mCommand == POVRAY_RENDER ? QLatin1String("SECAD-povray-render.err") : QLatin1String("SECAD-blender-render.err");
...
{
	return QDir(QDir::tempPath()).absoluteFilePath("SECAD-render.pov");
}
